...
local function OnPackageStart()
	...
	LoadWebFile(mapGui, "http://asset/" .. GetPackageName() .. "/pinmap/client/web/map.html")
	...
	LoadWebFile(miniMapGui, "http://asset/" .. GetPackageName() .. "/pinmap/client/web/minimap.html")
...
function PinmapEnableDevmode()
	...
	PinLog("You are admin. You can teleport via the right click on the map.")
	devMode = true
	if (mapUILoaded) then
		ExecuteWebJS(mapGui, "EnableDevMode();") --When EnableDevMode() is called in the js, it adds the menu option for "Teleport Here" in the right click menu on the map
	end
...
function OnKeyPress(key)
	if (key == OnlineKeys.MAP_KEY) then
